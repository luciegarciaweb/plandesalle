...
<body>
    <div id="app">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown"> 
                            ...
                            @endif
                            <a  class="dropdown-item" href="{{ route('home') }}"><i class="far fa-user"></i>{{ __(' Accueil ') }}</a>
        ...
        <main class="py-4" style="background: url(/image/profile.png); background-size: cover; 
        background-repeat: no-repeat; font-family: 'Exo 2', sans-serif; margin-top: none!important;">
            @yield('content')
        </main>
